...
export default function EventAdminBookingSearch() {
  ...
  const handleStatusUpdate = async (newStatus) => {
    ...
    try {
      setLoading(true)
      setError('')
      await API.put(`/event-admin/bookings/${booking._id}/status`, { status: newStatus })
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-white font-medium"
                >
              ...
              <div className="flex items-end">
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 disabled:opacity-60 font-bold text-lg transition"
                >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-indigo-600 to-indigo-700 rounded-lg shadow-lg p-8 text-white">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <p className="text-indigo-100 text-sm font-semibold mb-1">Total Amount</p>
                ...
                <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div className="bg-indigo-50 p-4 rounded-lg border border-indigo-200">
                      ...
                      <p className="text-3xl font-bold text-indigo-600">{booking.quantity || 0}</p>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <select
                        ...
                        disabled={loading}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-60 font-medium"
                      >
                    ...
                    <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-3 text-center">
                      <p className="text-xs text-indigo-600 font-semibold mb-1">Current Status</p>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {booking.qrCodes.slice(0, 4).map((qr, idx) => (
                        <button
                          ...
                          className="group relative overflow-hidden rounded-lg border-2 border-gray-300 hover:border-indigo-500 transition cursor-pointer bg-gray-50"
                        >
                          {qr.image && (
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-lg max-w-md w-full shadow-xl p-8">
              ...
              <div className="mb-4">
                ...
                <p className="font-mono text-base font-bold text-gray-900 bg-indigo-50 p-3 rounded border border-indigo-200">
