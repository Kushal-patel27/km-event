        ...
        >
          <div className={`rounded-2xl shadow-2xl p-8 backdrop-blur-lg border ${
            ...
            <div className="text-center mb-8">
              <h2 className={`text-3xl font-extrabold mb-2 ${isDarkMode ? 'text-blue-400' : 'text-blue-700'}`}>Welcome Back</h2>
              <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Login to your account</p>
            </div>
