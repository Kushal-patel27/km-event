              ...
              <div className="overflow-x-auto">
                ...
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    ...
                    <th className="px-2 sm:px-3 py-3 text-left text-sm font-semibold text-gray-900">Type</th>
                    ...
                    <th className="px-3 sm:px-6 py-3 text-left text-sm font-semibold text-gray-900">IP Address</th>
