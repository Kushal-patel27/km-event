        ...
        <div className="flex items-center justify-between h-16 ">
          ...
          <div className="hidden md:flex items-center gap-3">
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${isHomePage ? 'text-gray-200 hover:bg-white/10' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'}`}
